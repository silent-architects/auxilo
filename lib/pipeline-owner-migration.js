...
const { normalizeCreditingContributorAccountId } = require('./accounts.js');
        ...
        for (const l of learnings) {
            if (l && l.id) {
                ownerByLearning[l.id] = {
                    // SEED-ATTR: a platform account is attribution metadata,
                    // not a destination for this historical earnings repair.
                    account_id: normalizeCreditingContributorAccountId(l.contributor_account_id),
