...
4. Wire to scheduler: `~/Library/LaunchAgents/tech.conway.auxilo-digest.plist` running at 07:00 daily. `plutil -lint` must pass. Do NOT `launchctl load` — leave loading for the deploy gate.
