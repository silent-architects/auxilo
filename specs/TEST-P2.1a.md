...
4. Load agent: `launchctl load ~/Library/LaunchAgents/io.auxilo.sweeper.plist`. *(2026-07-15: label renamed `io.auxilo.sweeper`, purging a dead legacy host prefix; the launchd sweeper is currently retired-archived — extraction runs via the SessionEnd hook.)*
