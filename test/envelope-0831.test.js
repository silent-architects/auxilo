...
describe('ENVELOPE-0831 OpenAPI truth', () => {
  it('omits buyer and public per-item earnings fields, documents owner by-learning detail, and holds version 0.9.14', () => {
    ...
    assert.equal(OPENAPI.info.version, '0.9.14');
  });
});
